...
(function () {
  ...
  const TAP_HINT_SVG = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 6l6 6-6 6"/></svg>';
        ...
        <div class="menu-list">
          ${cat.items
            ...
            <button type="button" class="menu-item"
              ...
              <span class="menu-item-tap-hint" aria-hidden="true">${TAP_HINT_SVG}</span>
            </button>`
            )
            .join("")}
        </div>
